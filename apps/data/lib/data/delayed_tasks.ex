defmodule Data.DelayedTasks do
  ...
  """
  @spec update_task(DelayedTask.t(), map()) ::
          {:ok, DelayedTask.t()} | {:error, Ecto.Changeset.t()}
  ...
  """
  @spec update_task_state(String.t(), String.t(), map() | nil) ::
          {:ok, DelayedTask.t()} | {:error, any()}
  ...
  """
  @spec lock_for_processing(String.t()) ::
          {:ok, DelayedTask.t()} | {:error, :already_processing | :not_found}
  ...
  """
  @spec list_recent_tasks(integer()) :: [DelayedTask.t()]
  def list_recent_tasks(limit \\ 50) do
    from(t in DelayedTask,
      distinct: t.id,
